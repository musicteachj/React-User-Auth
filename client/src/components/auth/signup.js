...
class Signup extends Component {
  ...
  render() {
    const { handleSubmit, fields: { name, bio, city, skill, email, password, passwordConfirm }} = this.props;
    ...
    return (
      <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
        ...
        <fieldset className="form-group">
          <label>Bio:</label>
          <textarea className="form-control" rows="4" {...bio} />
        ...
        <fieldset className="form-group">
          <label>Skill Level: (Beginner, Intermediate, Advanced)</label>
...
export default reduxForm({
  form: 'signup',
  fields: ['name', 'bio', 'city', 'skill', 'email', 'password', 'passwordConfirm'],
  validate
